...
![image-20240229161316162](9-http协议详解和相关工具.assets/image-20240229161316162.png)

这样上图的1697584010就终于搞明白了，

![image-20240229163022712](9-http协议详解和相关工具.assets/image-20240229163022712.png)



至于下面的1697583766是request，client请求的时候的时间是client打上去的time()就是这个时候

![image-20240229163117256](9-http协议详解和相关工具.assets/image-20240229163117256.png)
