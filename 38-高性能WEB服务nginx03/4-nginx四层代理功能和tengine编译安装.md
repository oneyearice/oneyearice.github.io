...
👆关于图中的zabbix ser的针对testping[a.b.c.d]的写法补充，就是直接在键值里写testping[8.8.8.8]这种带具体ip的就行了。

![image-20260115151547436](4-nginx四层代理功能和tengine编译安装.assets/image-20260115151547436.png)
