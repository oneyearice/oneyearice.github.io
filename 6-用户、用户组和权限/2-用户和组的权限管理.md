...
[root@centos7 ~]# date -s "+5 day"  # 这个必须root才能修改成功
...
![image-20220701181230711](2-用户和组的权限管理.assets/image-20220701181230711.png)
...
<img src="2-用户和组的权限管理.assets/image-20220118121111755.png" alt="image-20220118121111755" style="zoom:67%;" /> 
...
<img src="2-用户和组的权限管理.assets/image-20220118122456908.png" alt="image-20220118122456908" style="zoom: 50%;" /> 
...
修改目录下所有文件和子目录的权限，这个<font color=red>R</font>特别的坑和<font color=red>rm</font>也差不多了
