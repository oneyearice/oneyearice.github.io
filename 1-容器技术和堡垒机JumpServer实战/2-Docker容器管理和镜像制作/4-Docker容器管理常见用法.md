...
![image-20240425184906817](4-Docker容器管理常见用法.assets/image-20240425184906817.png)

诺，是不是so easy，再找找busybox的PS1变量落在那个文件里就行了

如果实在找不到文件，就用-e的方式传进去也行啊。

![image-20240425185250322](4-Docker容器管理常见用法.assets/image-20240425185250322.png)
...
![image-20240426100731730](4-Docker容器管理常见用法.assets/image-20240426100731730.png)





# 案例，使用docker自动部署一个开源运维软件
